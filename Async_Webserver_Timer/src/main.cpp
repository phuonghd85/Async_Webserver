...
<body>
  ...
  <p><input type="range" onchange="updateSliderTimer(this)" id="timerSlider" min="1" max="30" value="%TIMERVALUE%" step="1" class="slider2"></p>
  %BUTTONPLACEHOLDER%
<script>
